...
class robot:
    ...
    def __init__(self, x = 0.0, y = 0.0, heading = 0.0, turning = 2*np.pi/10, distance = 1.0):
    ...
    def move(self, turning, distance, tolerance = 0.001, max_turning_angle = np.pi):
        ...
        self.x += distance * np.cos(self.heading)
        self.y += distance * np.sin(self.heading)
